import {quiz_cinema} from './questionscinema.js';      //Fonction qui importe le tableau de question depuis question.js 
...
let correctAnswer = quiz_cinema.questions[currentQuestionIndex].correct_answer       //Declaration de variable pour initialiser la bonne réponse à 0 (première réponse)
...
let maxBar = quiz_cinema.questions.length;  //Valeur maximale de la barre de progression
...
function loadQuestion(){ 
  ...
  myFirstQuestion = quiz_cinema.questions[currentQuestionIndex];  //Déclaration de variable récupérant les éléments de la question en fonction de l'index
...
if (currentQuestionIndex < quiz_cinema.questions.length) {                  //ajout d'une première condition qui charge la question suivante tant qu'on ne dépasse pas la limite de l'index
  correctAnswer =  quiz_cinema.questions[currentQuestionIndex].correct_answer
  loadQuestion();
  ...
  correctAnswer =  quiz_cinema.questions[currentQuestionIndex].correct_answer     // Réinitialise la bonne réponse en fonction de l'index
}
});
